...
const ContactUs = () => {
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "44940082-7021-4d51-810b-33a57420fb47");
  ...
  return (
    ...
    id='contact-us' className='flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
      <Title title='Reach out to us' desc='Have questions or need support? Reach out us—we’re here to guide you every step of the way.'/>
      ...
      onSubmit={onSubmit} className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full'>
        ...
        <button type="submit" className='w-max flex gap-2 bg-tertiary text-white text-sm px-10 py-3 rounded-full cursor-pointer hover:scale-103 transition-all'>
